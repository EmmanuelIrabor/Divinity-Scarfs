...
export default function Navbar({ isDark = false }: { isDark?: boolean }) {
  ...
  return (
    <div>
      ...
      >
        <NavItem text="COLLECTION" route="../Divinity-Scarfs/Collection" />
        <NavItem text="SHOP" route="../Divinity-Scarfs/Shop" />
        <NavItem text="ABOUT" route="../Divinity-Scarfs/About" />
        <NavItem text="CONTACT" route="../Divinity-Scarfs/Contact" />
        <NavItem text="MORE" route="../Divinity-Scarfs/More" />
      </nav>
