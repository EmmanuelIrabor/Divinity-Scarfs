  ...
  useEffect(() => {
    ...
    const loadRegionalData = async () => {
      try {
        ...
        let data;
        if (continentCode === "AF") {
          data = await import("@/app/Divinity-Scarfs/data/ScarfsAF.json");
        } else {
          data = await import("@/app/Divinity-Scarfs/data/ScarfsEU.json");
        }
        ...
        // Fallback to EU data
        const fallbackData = await import("@/app/Divinity-Scarfs/data/ScarfsEU.json");
